...
let MkmStarRating = class {
  ...
  renderStars() {
    ...
    for (let i = 1; i <= this.maxStars; i++) {
      stars.push(index.h("svg", { class: i <= this.currentRate ? "active" : "deactive", viewBox: "0 0 100 100", height: "20", width: "20" }, index.h("polygon", { points: "50,0 15,95 100,35 0,35 85,95", style: starProp })));
    }
    return stars;
  }
  render() {
    return (index.h("div", null, this.renderStars()));
  }
};
...
exports.mkm_star_rating = MkmStarRating;
